...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['ccdn_forum_forum.component.flood_control'] = new \CCDNForum\ForumBundle\Component\FloodControl($this->get('security.context'), $this->get('session'), 'prod', 4, 1);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_63a497fa5e31997f8840506028f9b17ae400156f50ab0bea0c1214eaba854cbc');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_63a497fa5e31997f8840506028f9b17ae400156f50ab0bea0c1214eaba854cbc');
        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_63a497fa5e31997f8840506028f9b17ae400156f50ab0bea0c1214eaba854cbc');
        ...
        $i->setProxyDir('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/sonata/admin', false);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/translations', 'debug' => false));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'HackzillaTicketBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod',
            ...
            'session.save_path' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/sessions',
            ...
            'router.resource' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/prod/doctrine/orm/Proxies',
            ...
            'ccdn_forum_forum.topic.user.flood_control.post_limit' => 4,
            'ccdn_forum_forum.topic.user.flood_control.block_for_minutes' => 1,
