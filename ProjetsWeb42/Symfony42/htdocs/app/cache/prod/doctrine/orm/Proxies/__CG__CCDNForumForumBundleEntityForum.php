 ...
 */
class Forum extends \CCDNForum\ForumBundle\Entity\Forum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'readAuthorisedRoles', 'categories');
        }
     ...
     * {@inheritDoc}
     */
    public function setCategories(\Doctrine\Common\Collections\ArrayCollection $categories = NULL)
    {
     ...
     * {@inheritDoc}
     */
    public function addCategory(\CCDNForum\ForumBundle\Entity\Category $category)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCategory(\CCDNForum\ForumBundle\Entity\Category $category)
    {
