...
class __TwigTemplate_f0bf19a1639b3e8ae529425d54f7702fc449a952a64c47505a36890f5d994c94 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ccdn_forum_forum"]) ? $context["ccdn_forum_forum"] : null), "subscription"), "list"), "layout_template");
...
\t\t\t<ul class=\"nav nav-tabs\">";
        ...
        $context["tabs"] = $this;
        // line 54
        if ((!(null === (isset($context["forum"]) ? $context["forum"] : null)))) {
            // line 55
            echo $context["tabs"]->getsubscription_tab("all", (isset($context["forumName"]) ? $context["forumName"] : null), "all", (isset($context["filter"]) ? $context["filter"] : null), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_read", array(), "array"), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_unread", array(), "array"), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_total", array(), "array"));
            // line 56
            echo $context["tabs"]->getsubscription_tab("unread", (isset($context["forumName"]) ? $context["forumName"] : null), "unread", (isset($context["filter"]) ? $context["filter"] : null), null, $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_unread", array(), "array"), null);
            // line 57
            echo $context["tabs"]->getsubscription_tab("read", (isset($context["forumName"]) ? $context["forumName"] : null), "read", (isset($context["filter"]) ? $context["filter"] : null), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_read", array(), "array"), null, null);
        } else {
            // line 59
            echo $context["tabs"]->getsubscription_tab("all", "~", "all", (isset($context["filter"]) ? $context["filter"] : null), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_read", array(), "array"), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_unread", array(), "array"), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_total", array(), "array"));
            // line 60
            echo $context["tabs"]->getsubscription_tab("unread", "~", "unread", (isset($context["filter"]) ? $context["filter"] : null), null, $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_unread", array(), "array"), null);
            // line 61
            echo $context["tabs"]->getsubscription_tab("read", "~", "read", (isset($context["filter"]) ? $context["filter"] : null), $this->getAttribute((isset($context["total_subscribed_forums"]) ? $context["total_subscribed_forums"] : null), "count_read", array(), "array"), null, null);
        }
        // line 63
        echo "</ul>
\t\t</div>
...
\t\t\t<tbody>";
        ...
        foreach ($context['_seq'] as $context["row"] => $context["subscription"]) {
            // line 83
            $context["topic"] = $this->getAttribute((isset($context["subscription"]) ? $context["subscription"] : null), "getTopic");
            // line 85
...
\t</section>";
    ...
    public function getsubscription_tab($_label = null, $_forum_name = null, $_filter_key = null, $_filter_value = null, $_count_read = null, $_count_unread = null, $_count_total = null)
    {
        ...
        try {
            // line 17
            if (((isset($context["filter_key"]) ? $context["filter_key"] : null) == (isset($context["filter_value"]) ? $context["filter_value"] : null))) {
                // line 18
            ...
            // line 22
            echo "<a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_subscription_index", array("forumName" => (isset($context["forum_name"]) ? $context["forum_name"] : null), "filter" => (isset($context["filter_key"]) ? $context["filter_key"] : null))), "html", null, true);
            echo "\">";
            // line 23
...
\t\t\t<span class=\"badge\">";
            // line 28
            if (((!(null === (isset($context["count_unread"]) ? $context["count_unread"] : null))) && (!(null === (isset($context["count_total"]) ? $context["count_total"] : null))))) {
                // line 29
                echo twig_escape_filter($this->env, (isset($context["count_unread"]) ? $context["count_unread"] : null), "html", null, true);
                // line 30
                echo "&nbsp;/&nbsp;";
                // line 31
                echo twig_escape_filter($this->env, (isset($context["count_total"]) ? $context["count_total"] : null), "html", null, true);
            } else {
                // line 33
                if ((!(null === (isset($context["count_unread"]) ? $context["count_unread"] : null)))) {
                    // line 34
                    echo twig_escape_filter($this->env, (isset($context["count_unread"]) ? $context["count_unread"] : null), "html", null, true);
                }
                // line 37
                if ((!(null === (isset($context["count_read"]) ? $context["count_read"] : null)))) {
                    // line 38
                    echo twig_escape_filter($this->env, (isset($context["count_read"]) ? $context["count_read"] : null), "html", null, true);
                }
            }
            // line 41
            echo "</span>
