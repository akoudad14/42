...
class __TwigTemplate_47dc1960f50ed6fadef469b9ce89e03f03dd6eaa37e63665e12d48b67a567275 extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ccdn_forum_forum"]) ? $context["ccdn_forum_forum"] : null), "category"), "user"), "show"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.category.show", array("%category_name%" => $this->getAttribute($this->getAttribute((isset($context["categories"]) ? $context["categories"] : null), 0, array(), "array"), "name")), "CCDNForumForumBundle"), "html", null, true);
    }
