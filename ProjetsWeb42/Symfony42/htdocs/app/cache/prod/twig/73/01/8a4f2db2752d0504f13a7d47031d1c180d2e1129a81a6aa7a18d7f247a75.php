...
\t    <td class=\"center\">";
        // line 4
        if ($this->env->getExtension('authorizer')->canCreateTopicOnBoard((isset($context["board"]) ? $context["board"] : null), (isset($context["forum"]) ? $context["forum"] : null))) {
            // line 5
            if ($this->env->getExtension('authorizer')->canReplyToTopicOnBoard((isset($context["board"]) ? $context["board"] : null), (isset($context["forum"]) ? $context["forum"] : null))) {
                // line 6
...
\t            <a href=\"";
        // line 21
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_board_show", array("forumName" => (isset($context["forumName"]) ? $context["forumName"] : null), "boardId" => $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getId"))), "html", null, true);
        echo "\" title=\"";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getName"), "html", null, true);
        echo "\">";
        // line 22
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getName"), "html", null, true);
        // line 23
...
\t\t\t<blockquote class=\"slim\">";
        // line 27
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getDescription"), "html", null, true);
        // line 28
        echo "</blockquote>
\t    </td>
...
\t\t\t<span class=\"label label-info lead\" title=\"";
        // line 32
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getCachedTopicCount"), "html", null, true);
        echo "\">";
        // line 33
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getCachedTopicCount"), "html", null, true);
        // line 34
...
\t\t\t<span class=\"label label-info lead\" title=\"";
        // line 38
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getCachedPostCount"), "html", null, true);
        echo "\">";
        // line 39
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getCachedPostCount"), "html", null, true);
        // line 40
...
\t    <td class=\"center\" style=\"width:170px;\">";
        // line 44
        if ($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost")) {
            // line 45
            if ($this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getTopic")) {
                // line 46
                echo $this->env->getExtension('translator')->trans("post.posted-by", array(), "CCDNForumForumBundle");
                // line 47
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getCreatedBy"), "html", null, true);
                // line 49
                echo "<br>
...
\t\t\t\t\t";
                ...
                if (((isset($context["page"]) ? $context["page"] : null) < 2)) {
                    // line 57
                    echo "<a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_topic_show", array("forumName" => (isset($context["forumName"]) ? $context["forumName"] : null), "topicId" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getTopic"), "getId"))), "html", null, true);
                    echo "#";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getId"), "html", null, true);
                    echo "\">
\t\t\t\t\t\t\t<i class=\"glyphicon glyphicon-arrow-right\"></i>
\t                        <abbr class=\"timestamper\" title=\"";
                    // line 59
                    echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getCreatedDate"), "Y-m-d H:i:s T Z", "Europe/London"), "html", null, true);
                    echo "\">";
                    // line 60
                    echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getCreatedDate"), $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ccdn_forum_forum"]) ? $context["ccdn_forum_forum"] : null), "category"), "user"), "last_post_datetime_format")), "html", null, true);
                    // line 61
                    echo "</abbr>
\t                    </a>";
                } else {
                    // line 64
                    echo "<a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_topic_show_paginated", array("forumName" => (isset($context["forumName"]) ? $context["forumName"] : null), "topicId" => $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getTopic"), "getId"), "page" => (isset($context["page"]) ? $context["page"] : null))), "html", null, true);
                    echo "#";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getLastPost"), "getId"), "html", null, true);
                    echo "\">
\t\t\t\t\t\t\t<i class=\"glyphicon glyphicon-arrow-right\"></i>
