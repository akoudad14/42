...
class __TwigTemplate_c6a6ab3310adec378e1d3ef2e99c6911406c9c23545ccee6edcdbeba8fbdd95c extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ccdn_forum_forum"]) ? $context["ccdn_forum_forum"] : null), "post"), "user"), "show"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.post.show", array("%post_id%" => $this->getAttribute((isset($context["post"]) ? $context["post"] : null), "getId")), "CCDNForumForumBundle"), "html", null, true);
    }
