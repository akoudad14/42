...
class __TwigTemplate_3d11376ff5864b656e2ac62cab006811d71e36bcfcc4f96f9f7135053ae108ac extends Twig_Template
{
    ...
    {
        // line 3
        $context["LayoutTemplate"] = $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ccdn_forum_forum"]) ? $context["ccdn_forum_forum"] : null), "topic"), "user"), "create"), "layout_template");
    ...
    {
        // line 6
        echo twig_escape_filter($this->env, $this->env->getExtension('translator')->trans("title.topic.create", array("%board_name%" => $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "getName")), "CCDNForumForumBundle"), "html", null, true);
    }
    ...
    public function block_body_content($context, array $blocks = array())
    {
        ...
        // line 20
        $this->env->getExtension('form')->renderer->setTheme((isset($context["form"]) ? $context["form"] : null), array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["ccdn_forum_forum"]) ? $context["ccdn_forum_forum"] : null), "topic"), "user"), "create"), "form_theme")));
        // line 21
        echo "<form action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_topic_create_process", array("forumName" => (isset($context["forumName"]) ? $context["forumName"] : null), "boardId" => $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "id"))), "html", null, true);
        echo "\"
\t\t method=\"post\" ";
        // line 22
...
\t\t\t\t</div>";
        ...
        // line 33
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "Topic"), "board"), 'row');
        // line 35
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "Topic"), "title"), 'row');
        // line 37
...
\t\t\t\t\t\t<a class=\"btn btn-default\" href=\"";
        // line 51
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("ccdn_forum_user_board_show", array("forumName" => (isset($context["forumName"]) ? $context["forumName"] : null), "boardId" => $this->getAttribute((isset($context["board"]) ? $context["board"] : null), "id"))), "html", null, true);
        echo "\">";
        // line 52
...
\t</section>";
        ...
        if (array_key_exists("preview", $context)) {
            // line 62
            if ((!twig_test_empty((isset($context["preview"]) ? $context["preview"] : null)))) {
                // line 63
                $this->env->loadTemplate("CCDNForumForumBundle:User:Post/Partial/post_preview.html.twig")->display(array_merge($context, array("post" => (isset($context["preview"]) ? $context["preview"] : null))));
            }
        }
        echo trim(preg_replace('/>\s+</', '><', ob_get_clean()));
    }
