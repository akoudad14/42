...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev/annotations', true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addResolveTargetEntity('Symfony\\Component\\Security\\Core\\User\\UserInterface', 'Intra\\UserBundle\\Entity\\User', array());
        ...
        $d->addEventListener(array(0 => 'postLoad'), $this->get('hackzilla_ticket.listener'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '3307', 'dbname' => 'intra', 'user' => 'root', 'password' => 'marvin14', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $d, array());
    }
    ...
    /**
     * Gets the 'hackzilla_ticket.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Hackzilla\Bundle\TicketBundle\EventListener\UserLoad A Hackzilla\Bundle\TicketBundle\EventListener\UserLoad instance.
     */
    ...
    /**
     * Gets the 'hackzilla_ticket.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Hackzilla\Bundle\FOSUserBridgeBundle\User\FOSUser A Hackzilla\Bundle\FOSUserBridgeBundle\User\FOSUser instance.
     */
    ...
    /**
     * Gets the 'hackzilla_ticket_user_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Hackzilla\Bundle\TicketBundle\Extension\UserExtension A Hackzilla\Bundle\TicketBundle\Extension\UserExtension instance.
     */
    ...
    /**
     * Gets the 'intra_user.admin.user' service.
     *
     * @return Intra\UserBundle\Admin\UserAdmin A Intra\UserBundle\Admin\UserAdmin instance.
     */
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sonata.admin.route.cache'] = new \Sonata\AdminBundle\Route\RoutesCache('/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev/sonata/admin', true);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/../web', true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'debug.container.dump' => '/Volumes/Data/nfs/zfs-student-3/users/2013/makoudad/mamp/apps/symfony/htdocs/app/cache/dev/appDevDebugProjectContainer.xml',
